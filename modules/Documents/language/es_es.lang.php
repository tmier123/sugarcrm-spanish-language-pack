...
'ERR_MISSING_FILE'                                 => 'Este documento no encuentra un archivo, muy probablemente debido a un error durante la carga. Por favor vuelva a intentar de cargar el archivo o póngase en contacto con el administrador.',
...
'LBL_DOC_ID'                                       => 'ID de documento fuente',
'LBL_DOC_TYPE'                                     => 'Fuente',
'LBL_LIST_DOC_TYPE'                                => 'Fuente',
'LBL_DOC_TYPE_POPUP'                               => 'Seleccione una fuente para que este documento sea cargado <br> y de la que estará disponible.',
'LBL_DOC_URL'                                      => 'URL del Documento',
'LBL_SEARCH_EXTERNAL_DOCUMENT'                     => 'Nombre de archivo',
'LBL_EXTERNAL_DOCUMENT_NOTE'                       => 'Los primeros 20 archivos modificados más recientemente se muestran en orden descendente de la lista de abajo. Use la búsqueda para encontrar otros archivos.',
...
'ERR_INVALID_EXTERNAL_API_LOGIN'                   => 'La comprobación de inicio de sesión fallido por API externa ({0})',
