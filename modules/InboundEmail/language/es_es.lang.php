...
'LBL_FROM_ADDR_DESC'                               => 'La dirección de correo electrónico proporcionada aquí posiblemente no aparezca en el campo "De" sección de la dirección del correo electrónico enviado debido a las restricciones impuestas por el proveedor de servicios de correo. En estas circunstancias, la dirección de correo electrónico se define en el servidor de correo saliente se utilizará.',
